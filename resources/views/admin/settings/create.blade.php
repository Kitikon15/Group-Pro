...
@section('content')
<div class="container">
    <h1>เพิ่มการตั้งค่าระบบใหม่</h1>
    <a href="{{ route('admin.settings.index') }}" class="btn-list">รายการข้อมูล</a>

    <form action="{{ route('admin.settings.store') }}" method="POST" class="edit-form">
        @csrf
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <select id="type" name="type">
                    <option value="string">ข้อความสั้น</option>
                    <option value="text">ข้อความยาว</option>
                    <option value="boolean">ค่าจริง/เท็จ</option>
                    <option value="integer">ตัวเลข</option>
                </select>
            </div>
        </div>
